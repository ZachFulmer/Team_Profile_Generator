...
class Team
{
    constructor()
    {
        //This array keeps track of all team members
        this.team = [];
    }
    ...
    addTeamMember(role)
    {
        // Gets all shared Parent Class Property data for the added member
        inquirer.prompt([
            {
                type: 'input',
                name: 'name',
        ...
        {
            // Gets Specific Team Member data based on role
            if(role == "Manager")
            {
                inquirer.prompt([
                    {
    ...
    generateHTML()
    {
        ...
        // Add Cards for each member on the team
